...
A three-layer medallion warehouse for the Superstore dataset, built with
**dbt-core** on **PostgreSQL**. Raw CSV lands in bronze, is modelled as a
Data Vault 2.0 in silver, and is served as a star schema in gold.
